...
public:
	...
	{
		float area = 0.5f * fabs( crossProduct( vector2 - vector1, vector3 - vector1 ) );

		alpha = 0.5f * fabs( crossProduct( vector2 - position, vector3 - position ) ) / area;

		beta = 0.5f * fabs( crossProduct( vector1 - position, vector3 - position ) ) / area;

		gamma = 0.5f * fabs( crossProduct( vector1 - position, vector2 - position ) ) / area;

		if (fabs( 1.0f - alpha - beta - gamma ) > 0.00001f) return false;
